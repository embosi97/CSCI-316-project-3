 ...
 * that contain a string "classname" (the name of the class/super class) and an
 * integer "frequency" (the number of instances of a class within the data
 * structure I devised in the Parser class (familyList).
 * 
 * The setArg2 function creates an ArrayList of these objectClass objects which
 * is then sorted by the frequency and printed onto text file (provided by
 * argsv[2]), thanks to these modified compareTo and toString function in the
 * objectClass class. setArg2 is called in Parser.main.
 * 
 * The Collections package is used to sort and find the frequency of classes
 * within Parser's data structure.
 **/
